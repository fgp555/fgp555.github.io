...
<!-- Azure -- gap detectado en oferta de Synopsis (DevOps Engineer, 2026-09-06) -->

### Azure (gap real, hoy 0 experiencia — todo el roadmap es AWS/GCP)
⏳ Azure DevOps: Pipelines YAML (equivalente a GitHub Actions pero en Azure)
⏳ Azure Container Registry / Azure Container Instances o AKS (equivalente a ECR/EKS)
⏳ Azure Key Vault (equivalente a Secrets Manager)
⏳ Certificación DevSecOps (valorada en varias ofertas, no solo Synopsis)